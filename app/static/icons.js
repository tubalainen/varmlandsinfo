...
// Ikoner (SVG, linjestil). Konstanta strängar som byggs till element. Ingen användardata passerar här.
const ICONS = {
  ...
  panel: '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18M16 15l-3-3 3-3"/>',
...
// Statisk HTML: <span data-icon="namn"></span>
for (const ph of document.querySelectorAll("[data-icon]")) ph.replaceWith(icon(ph.dataset.icon, ph.className));
